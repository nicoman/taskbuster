...
- In virtual environments **postactivate** files (see section below), you have to change **taskbuster.setting.development** for your **projectname.settings.development**. Same works for testing environment.
...
You can also especiy a dialect, like Luxembourg's German with::
...
We need to update the languages in our Test to make sure the translation works correctly. Open the file *functional_test/test_all_users.py*:
